...
# Regression testing script for Strux
...
Check() {
    ...
    Run "$CC" "-o" "${basename}.exe" "${basename}.s" "queue.bc" "printbig.o" &&
...
CheckFail() {
    ...
    RunFail "$STRUX" "<" $1 "2>" "${basename}.err" ">>" $globallog &&
